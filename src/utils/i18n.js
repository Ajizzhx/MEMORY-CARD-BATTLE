...
export const TRANSLATIONS = {
  ID: {
    ...
    modeBossDesc: 'Tantangan 42 Kartu (21 Pasang) lawan Abyss Omega 400 HP! Grid 14×3 (Disarankan main di Desktop untuk tampilan grid yang pas).',
  ...
  EN: {
    ...
    modeBossTitle: '🐉 Boss Challenge',
    modeBossDesc: 'All 42 Cards (21 Pairs) vs Abyss Omega 400 HP! Grid 14×3 (Recommended to play on Desktop for optimal grid layout).',
