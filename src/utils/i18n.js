...
export const TRANSLATIONS = {
  ID: {
    ...
    modeBossDesc: 'Tantangan 42 Kartu (21 Pasang) lawan Abyss Omega 400 HP! Grid 6×7. (Disarankan main di Desktop 🖥️)',
  ...
  EN: {
    ...
    modeBossTitle: '🐉 Boss Challenge',
    modeBossDesc: 'All 42 Cards (21 Pairs) vs Abyss Omega 400 HP! 6×7 Grid. (Desktop recommended 🖥️)',
